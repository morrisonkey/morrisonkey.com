  ...
  render () {
    return (
      <Switch>
        ...
        <Route exact path='/teamweek' component={() => { window.location = 'https://medium.com/ironhack/enhancing-my-design-tool-stack-creating-an-animated-prototype-with-invision-studio-2e6b6e30ff02?source=friends_link&sk=4fed537c2b3280f62a15328f1a443601'; return null;} }/>
        <Route exact path='/briefly' component={() => { window.location = 'https://blog.usejournal.com/briefly-get-briefed-on-the-fly-754c92ac1e9?source=friends_link&sk=092cf7a01d61f1b2cdbb6803ee4d7316'; return null;} }/>
        <Route exact path='/filterbuds' component={() => { window.location = 'https://medium.com/ironhack/diving-deeper-into-ux-ui-my-first-client-project-fe0aee31b1fc?source=friends_link&sk=fb590cbf36412b1c7c1348a844c09602'; return null;} }/>
